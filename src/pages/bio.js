      ...
      <div className="px-6 lg:px-0 max-w-screen-xl mx-auto">
        ...
        <div className="flex flex-col">
          <p className="text-gray-800 my-8 text-lg">
            ...
            Duke Ellington, Glenn Miller, Count Basie, Woody Herman, Lawrence
            Welk and Louis Armstrong were some of the bigger names that passed
            through
          </p>
          ...
          <p className="text-gray-800 my-8 text-lg">
            ...
            Bobby Darin, Johnny Horton, Wanda Jackson, Gene Pitney, The 4
            Seasons, Neil Sedaka, The Fendermen, Marty Robbins, Duane Eddy,
            Brian Hyland, Johnny &amp; the Hurricanes and Bobby Rydell are but a
            mere sampling.
          </p>
          <hr className="style-eight" />
          <p className="text-gray-800 my-8 text-lg">
            ...
            revamped lineup was rushed together to finish the remaining thirteen
            dates of the tour. The “Winter Dance Party” lineup that appeared at
            Danceland included holdovers Dion &amp; the Belmonts, The Crickets
            (with Ronnie Smith on lead vocals) and Frankie Sardo who were joined
            by Frankie Avalon and Jimmy Clanton.
          </p>
          <hr className="style-eight" />
          <p className="text-gray-800 my-8 text-lg">
          ...
          <p className="text-gray-800 my-8 text-lg">
            ...
            Danceland’s stage as headliners or as the opening act for a national
            touring group.
          </p>
          <hr className="style-eight" />
          <p className="text-gray-800 my-8 text-lg">
            Danceland was a second story ballroom above a bowling alley! At the
            top of the large stairway were large (28” x 44”) hand-painted
            ...
            Danceland Poster Collection” have become quite the collector’s item
            today.
          </p>
          <hr className="style-eight" />
          <p className="text-gray-800 my-8 text-lg">
