      ...
      edges {
        node {
          ...
          data {
            ...
            audioBetween9and10title
            audioBetween9and10artist
          }
        }
      }
    }
          ...
          {data.january.edges.map(({ node }) => {
            return (
              ...
              >
                ...
                {node.data.audioBetween9and10 && (
                  <>
                    <div className="flex w-full justify-center mt-3">
                      <audio
                        src={node.data.audioBetween9and10[0].url}
                        controls
                        controlsList="nodownload"
                        preload="true"
                      ></audio>
                    ...
                    <div className="flex">
                      <p className="text-gray-700 text-lg">
                        {node.data.audioBetween9and10title} -{" "}
                        {node.data.audioBetween9and10artist}
                      </p>
                    </div>
                  </>
                )}
